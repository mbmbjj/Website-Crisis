...
<body>
    ...
    <section id="info-1">
        ...
        <div class="column-white" id='right-column'>
            <p class="infotxt">
                การแพ้อาหาร เป็นภาวะที่เกี่ยวกับการที่มีอาการแพ้หลังรับประทานอาหารนั้น
    ...
    <section>
        <div class="column-white">
            <h4 class="topic-small">โดยการแพ้อาหารแบ่งตามอาการแต่ละระบบได้เป็น</h4>
            <p class="infotxt">
            ...
            <div class="allerinfo">
                ...
                <ul>
                    ...
                    <b>ฉลากระบุคำว่า</b> <br>แป้งสาลี, <br>แป้งข้าวสาลี (wheat) ,<br>กลูเตน(gluten)
                        ,<br>Flour(แป้งฟราว์) ,<br>แป้ง spelt ,<br>มอล์ต(malt),<br> มอล์ตสกัด ,<br> Barley(บาเล่ย์)
        ...
        <div class="column-white">
            ...
            <div class="allerinfo">
                ...
                <ul>
                    ...
                    <li>
                    <b>ฉลากระบุคำว่า</b><br> ถั่วลิสง (peanut ) ,<br> nuts, mixed nuts
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="column-white">
            ...
            <div class="allerinfo">
                ...
                <ul>
                    ...
                    <li>
                    <b>ฉลากระบุคำว่า</b><br> นมผง ,<br>นมวัว (Cow’s milk) ,<br>เคซีน(casein) ,<br>เวย์
                        (whey)
                    </li>
                </ul>
            </div>
